...
describe('ChunksTable', () => {
  ...
  function render(
    ...
    const fixture = TestBed.createComponent(ChunksTable);
    const ref = fixture.componentRef as ComponentRef<ChunksTable>;
  ...
  describe('drill-in', () => {
    it('opens the chunk details dialog with the runId, chunk, and panel class', () => {
      ...
      expect(component).toBe(ChunkDetailsDialog);
