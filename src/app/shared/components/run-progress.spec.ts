...
describe('RunProgress', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({ imports: [RunProgress] });
  });
  ...
  function render(completed: number, total: number): Internals {
    const fixture = TestBed.createComponent(RunProgress);
    const ref = fixture.componentRef as ComponentRef<RunProgress>;
