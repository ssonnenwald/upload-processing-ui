...
import {
  ChunkDetailsDialogComponent,
  ChunkDetailsDialogData,
} from './chunk-details-dialog.component';
...
describe('ChunkDetailsDialogComponent', () => {
  ...
  function configure(
    ...
    TestBed.configureTestingModule({
      imports: [ChunkDetailsDialogComponent],
      providers: [
        RunsApi,
        provideHttpClient(),
        provideHttpClientTesting(),
  ...
  it('requests the chunk detail on creation and renders the row viewport', () => {
    configure();
    const fixture = TestBed.createComponent(ChunkDetailsDialogComponent);
