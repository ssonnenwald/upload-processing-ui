...
describe('RowCounts', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({ imports: [RowCounts] });
  });
  ...
  function render(counts: Counts): HTMLElement {
    const fixture = TestBed.createComponent(RowCounts);
    const ref = fixture.componentRef as ComponentRef<RowCounts>;
