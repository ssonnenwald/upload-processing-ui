...
@Component({
  ...
  templateUrl: './chunk-details-dialog.component.html',
  styleUrl: './chunk-details-dialog.component.scss',
})
export class ChunkDetailsDialogComponent {
  ...
  private readonly dialogRef = inject(
    MatDialogRef<ChunkDetailsDialogComponent>,
  );
