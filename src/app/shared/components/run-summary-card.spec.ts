...
describe('RunSummaryCard', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({ imports: [RunSummaryCard] });
  });
  ...
  function render(run: RunDetailsResponse): {
    ...
    const fixture = TestBed.createComponent(RunSummaryCard);
    const ref = fixture.componentRef as ComponentRef<RunSummaryCard>;
