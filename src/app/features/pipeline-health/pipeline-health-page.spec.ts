...
import { PipelineHealthPage } from './pipeline-health-page';
...
describe('PipelineHealthPage', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PipelineHealthPage],
      providers: [{ provide: PipelineHealthApi, useValue: api }],
    });
  });

  function render(): Internals {
    const fixture = TestBed.createComponent(PipelineHealthPage);
...
describe('PipelineHealthPage — auto-refresh polling', () => {
  let api: HealthApiMock;
