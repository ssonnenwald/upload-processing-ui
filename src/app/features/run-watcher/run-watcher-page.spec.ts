...
import { RunWatcherPage } from './run-watcher-page';
...
describe('RunWatcherPage', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.overrideComponent(RunWatcherPage, {
  ...
  function render(runId = 'RUN#1'): {
    internals: Internals;
    ref: ComponentRef<RunWatcherPage>;
  } {
    const fixture = TestBed.createComponent(RunWatcherPage);
