...
import { ChunkTimelineComponent } from './chunk-timeline.component';
...
describe('ChunkTimelineComponent', () => {
  beforeEach(() => {
    // Fix the clock — `window`/`bars` use Date.now() for running chunks.
    vi.useFakeTimers();
    vi.setSystemTime(NOW);
    TestBed.configureTestingModule({ imports: [ChunkTimelineComponent] });
  });
  ...
  function render(chunks: readonly ChunkSummary[]): Internals {
    const fixture = TestBed.createComponent(ChunkTimelineComponent);
    const ref = fixture.componentRef as ComponentRef<ChunkTimelineComponent>;
